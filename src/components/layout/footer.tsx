        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-start gap-4">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                <p className="font-headline font-bold text-lg">İstedad Mərkəzi</p>
          ...
          <div className="md:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/search" className="text-muted-foreground hover:text-primary">Axtarış</Link></li>
                <li><Link href="/rankings" className="text-muted-foreground hover:text-primary">Reytinq</Link></li>
              </ul>
            </div>
            <div>
